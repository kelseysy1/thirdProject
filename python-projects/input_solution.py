...
# use try/except
try:
    num=int(input("Enter a number: ")) #immediadetely cast it to an integer
    print(num)
    sum=num+2
except:
    print("you did not enter a number") #executes this if an error is thrown due to entering not-an-int
...
age = 14
print(f"{name} can vote in {18-age} years") #can print an expression, like 18 minus 14, not just variables.
